  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/ajibola.yusuf.1612"
            ...
            <li>
              <a
                href="https://www.instagram.com/stories/yusstoreverifiedproperty/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://x.com/Ajibola73718047"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/yusuf-tajudeen-8953a1276/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with 💖 by Tajudeen Yusuf</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
