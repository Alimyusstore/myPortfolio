...
function Footer() {
  ...
  const socialLinks = [
    {
      name: "Facebook",
      url: "https://www.facebook.com/ajibola.yusuf.1612",
      icon: (
        <svg
    ...
    {
      name: "Instagram",
      url: "https://www.instagram.com/stories/yusstoreverifiedproperty/",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
    ...
    {
      name: "Twitter/X",
      url: "https://x.com/Ajibola73718047",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
    ...
    {
      name: "LinkedIn",
      url: "https://www.linkedin.com/in/yusuf-tajudeen-8953a1276/",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
    ...
    {
      name: "GitHub",
      url: "https://github.com/Alimyusstore",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
      ...
      <div className="footer--content">
        <div className="footer--main">
          <div className="footer--brand">
            <div className="footer--logo">
              <img src="./img/mylogo.png" alt="Tajudeen Yusuf" />
              <h3>Tajudeen Yusuf</h3>
            </div>
            <p className="footer--description">
              Frontend Developer & Tech Leader with 4+ years of experience
              building scalable web applications. Passionate about creating
              exceptional user experiences and mentoring the next generation of
              developers.
            </p>
            ...
            <div className="footer--section">
              ...
              <ul>
                {quickLinks.map((link, index) => (
                  <li key={index}>
                    <Link
                      activeClass="footer--active-link"
                      spy={true}
                      smooth={true}
                      offset={-70}
                      duration={500}
            ...
            <div className="footer--section">
              ...
              <div className="contact--info">
                <p>
                  <strong>Email:</strong>
                  <br />
                  <a href="mailto:yusuftajudeenajibola@gmail.com">
                    yusuftajudeenajibola@gmail.com
                  </a>
                </p>
                <p>
                  <strong>Phone:</strong>
                  <br />
                  <a href="tel:+2347015237423">+234 701 523 7423</a>
                </p>
                <p>
        ...
        <div className="footer--bottom">
          <div className="footer--copyright">
            <p>
              © {currentYear} Tajudeen Yusuf. All rights reserved. Built with ❤️
              and React.js
            </p>
          </div>
