    ...
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        <div className="portfolio--container">
          <p className="sub--title">Featured Projects</p>
          <h2 className="section--heading">Portfolio Showcase</h2>
          <p className="portfolio--subtitle">
            A selection of projects demonstrating my technical expertise and
            leadership capabilities
          </p>
        </div>
        <div>
          <a
            href="https://github.com/Alimyusstore"
            target="_blank"
      ...
      <div className="portfolio--section--container enhanced">
        {data?.portfolio?.map((item, index) => (
          <div key={index} className="portfolio--section--card enhanced">
            ...
            <div className="portfolio--section--card--content">
              <div>
                ...
                <p className="text-md portfolio--description">
                  {item.description}
                </p>
